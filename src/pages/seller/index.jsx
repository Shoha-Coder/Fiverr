...
function Index() {
    ...
    return (
        <div className="w-[100%]">
            {userInfo && (
                <div
                    className="grid p200:grid-cols-1 w-[90%] p200:w mx-auto p1440:grid-cols-2 p200:gap-10 min-h-[80vh] my-10 mt-0 gap-5">
                        ...
                        <div className="flex gap-5 justify-center items-center">
                            <div>
                                {userInfo?.imageName ? (
                                    ...
                                    <div
                                        className="bg-purple-500 h-24 w-24 flex items-center justify-center rounded-full relative">
                ...
                <span className="text-[#62646a] text-lg font-medium">
                  {userInfo.username}
                    ...
                    <div>
                        <div
                            className="grid p200:grid-cols-1 p550:grid-cols-2 p800:grid-cols-3 p200:text-center gap-10 w-full">
                            <div
